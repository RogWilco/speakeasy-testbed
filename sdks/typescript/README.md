...
```bash
npm add https://gitpkg.now.sh/RogWilco/speakeasy-testbed/sdks/typescript
```

### PNPM

```bash
pnpm add https://gitpkg.now.sh/RogWilco/speakeasy-testbed/sdks/typescript
```

### Bun

```bash
bun add https://gitpkg.now.sh/RogWilco/speakeasy-testbed/sdks/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/RogWilco/speakeasy-testbed/sdks/typescript zod
